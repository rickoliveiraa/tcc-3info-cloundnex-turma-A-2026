 ...
 * 2. importar as funções da biblioteca do meu projeto
 *      linha 8 (import express .....)
...
const users = [
    { id:1, name:'João da Silva', gender:'M', email:'joão.silva@email.com' },
    { id:2, name:'Maria Mariana', gender:'F', email:'maria.mariana@email.com' },
    { id:3, name:'Claudia Goes', gender:'F', email:'claudia.goes@email.com' },
...
server.get ("/users/:id", (req, res) => {
    ...
    const id = parseInt(reportError.params.id);
